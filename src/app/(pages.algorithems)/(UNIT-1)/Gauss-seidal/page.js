...
const GaussSeidelPage = () => {
    return (
        ...
        \\end{cases}`}
                    ...
                    <p className="ml-5">Start with <BlockMath>{`( x_0 = 0, y_0 = 0, z_0 = 0 )`}</BlockMath></p>

                    <h3 className="mt-4">3. First Iteration:</h3>
                    <ul className="list-disc list-inside">
                        ...
                        <li>
                            ...
                            <BlockMath>{`z_1 = \\frac{18 - 2(3) - 0}{6} = 2`}</BlockMath>
                        </li>
                    </ul>

                    <h3 className="mt-4">4. Second Iteration:</h3>
                    <ul className="list-disc list-inside">
                        <li>
                            Calculate <InlineMath>{`( x_2 )`}</InlineMath>:
                            <BlockMath>{`x_2 = \\frac{12 - 4.8 - 2}{4} \\approx 1.3`}</BlockMath>
                        </li>
                        <li>
                            Calculate <InlineMath>{`( y_2 )`}</InlineMath>:
                            <BlockMath>{`y_2 = \\frac{27 - 1.3 - 2(2)}{5} \\approx 4.34`}</BlockMath>
                        </li>
                        <li>
                            Calculate <InlineMath>{`( z_2 )`}</InlineMath>:
                            <BlockMath>{`z_2 = \\frac{18 - 2(1.3) - 4.34}{6} \\approx 1.73`}</BlockMath>
                        </li>
                    </ul>
                    </div><div className="space-y-5 pb-8">
